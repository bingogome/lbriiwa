...
def generate_launch_description():
    object_param = os.path.join(get_package_share_directory('lbr_manipulator'), 'param', 'object_detection.yaml')
    object_model = os.path.join(get_package_share_directory('lbr_manipulator'), 'model', 'circbox.xml')
    multiplecamera_launch_dir = os.path.join(get_package_share_directory('lbr_manipulator'), 'launch')
    ...
    # Object Search Node
    searchnode = Node(
    package='lbr_manipulator', node_executable='object_detection_node.py', node_name='object_detection_node',
    output='screen',
    emulate_tty=True,
